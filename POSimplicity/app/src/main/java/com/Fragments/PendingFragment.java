...
public class PendingFragment  extends BaseFragment implements OnClickListener, TextWatcher {
	...
	private Button saveBtn,saveAndPrintWithWifi,tableAssign,saveAndPrintWithUSBAndBT,commentBt,clerkBtn;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
		...
		saveAndPrintWithWifi       = findViewIdAndCast(R.id.Fragment_Pending_Order_Btn_Save_And_Print_With_Wifi);
		saveAndPrintWithUSBAndBT   = findViewIdAndCast(R.id.Fragment_Pending_Order_Btn_Save_And_Print_With_USB);
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		saveAndPrintWithUSBAndBT .setOnClickListener(this);
		...
		if(PrintSettings.isAbleToPrintCustomerReceiptThroughUsb(mContext)){
			saveAndPrintWithUSBAndBT.setVisibility(View.VISIBLE);
		}		
	...
	public void onClick(View v) {
		...
		case R.id.Fragment_Pending_Order_Btn_Save_And_Print_With_USB:
			text = "Submit To "+ ((Button)v).getText().toString()+"!";
			okTOGoSimpleUSBWifiBluetoothPrinting(mContext,text,1);
			break;

		case R.id.Fragment_Pending_Order_Btn_Save_And_Print_With_Wifi:
			text = "Submit To "+ ((Button)v).getText().toString()+"!";
