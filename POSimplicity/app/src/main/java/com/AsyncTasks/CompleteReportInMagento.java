...
public class CompleteReportInMagento extends AsyncTask<Void, Integer, String> implements PrefrenceKeyConst {
    ...
    public CompleteReportInMagento(Context mContext, String orderStatus, String paymentMode, boolean savedInLocalDb) {
        ...
        Variables.startPrintingFromBG = false;
    ...
    protected String doInBackground(Void... params) {
        ...
        while (!Variables.startPrintingFromBG) {
    ...
    protected void onPostExecute(String result) {
        Log.d("CompleteReportInMagento", "Printing from " + CompleteReportInMagento.class.getName() + " Started");
        ...
        switch (statusCode) {
            ...
            case WebServiceCall.WEBSERVICE_CALL_NO_INTERENET:
                ...
                if (PrintSettings.isAbleToPrintCustomerReceiptThroughUsb(mContext)) {
                    new UsbPR(mContext, new PrinterCallBack() {
                        ...
                        public void onStarted(BasePR printerCmmdO) {
                            ...
                            new PrintReceiptCustomer(mContext).onFailedToSaveReciepts(parentList, surchargeList, total, discount, tax, netAmount, change, cash, check, rewardAmount, giftCard, creditAmt, printerCmmdO);
                        }
                    }).onStart();
                }
                ...
                if (PrintSettings.isAbleToPrintCustomerReceiptThroughBluetooth(mContext)) {
                    ...
                    new PrintReceiptCustomer(mContext).onFailedToSaveReciepts(parentList, surchargeList, total, discount, tax, netAmount, change, cash, check, rewardAmount, giftCard, creditAmt, globalApplication.getmBasePrinterBT());
                }
